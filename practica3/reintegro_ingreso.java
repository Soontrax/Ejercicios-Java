    ...
    public static void main(String[] args) {
        ...
        switch (opcion) {
            case 1:
                ...
                JOptionPane.showMessageDialog(null, "Tu dinero en tu cuneta es de:" + " " + (lista_cuentas.get(0).getSaldo()+ ingresar));
                break;
            case 2:
                int sacar = Integer.parseInt(JOptionPane.showInputDialog("¿Que cantidad quieres sacar?"));
                if (lista_cuentas.get(0).getSaldo() < sacar) {
                    JOptionPane.showMessageDialog(null, "Tu dinero en tu cuneta es de:" + " " + (lista_cuentas.get(0).getSaldo() +" "+ "Asi que no puedes sacar dinero"));
                } else {
                    JOptionPane.showMessageDialog(null, "En tu cuneta ahora tienes" + " " + (lista_cuentas.get(0).getSaldo()- sacar));
                }
                break;
            case 3:
